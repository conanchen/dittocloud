...
2. Message AuthenticateResponse
   ...
   | :--- | :--- | :--- |
   | access\_token | e.g. "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIxNDQyNm...wcXrS5yGtUoewAKqoqL5JhIQ109s1FMNopL\_50HR\_t4" | String in JWT format with claims:       sub: userid,, client: client\_id     |
